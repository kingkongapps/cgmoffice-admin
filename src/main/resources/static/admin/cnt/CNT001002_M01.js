...
window.addEventListener('CNT001002_M01', () => {
	CNT001002_M01.init();
})

const CNT001002_M01 = {
	targetElId: 'CNT001002_M01',
	init: function() {
	...
	search_01: async function() {
		...
		document.querySelector(`#${this.targetElId} [name='CNT001002_M01_totalCount_1']`).innerText = '총 건수 : ' + CMMN.priceToString(this.data.paginator_01.totalCount);
	},
	// 페이지 이동
	...
	search_02: async function() {
		...
		if(prdtCd) {
			...
			document.querySelector(`#${this.targetElId} [name='CNT001002_M01_totalCount_2']`).innerText = '총 건수 : ' + CMMN.priceToString(data.length);
		} else {
			this.data.gridOptions_02.api.setRowData([]);
		}
	},
