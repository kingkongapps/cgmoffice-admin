...
const MONTH_MORE_VIEW_HEADER_HEIGHT = 30;
const MONTH_MORE_VIEW_HEADER_MARGIN_BOTTOM = 0;
const MONTH_MORE_VIEW_HEADER_PADDING_TOP = 12;
const MONTH_MORE_VIEW_HEADER_PADDING = '2px 17px 0'; // week day name
...
function SeeMoreEventsPopup() {
  ...
  const moreViewListStyle = {
    height: "calc(100% - ".concat(MONTH_MORE_VIEW_HEADER_HEIGHT + MONTH_MORE_VIEW_HEADER_MARGIN_BOTTOM + MONTH_MORE_VIEW_HEADER_PADDING_TOP - 10, "px)")
  };
  return compat_module_V(h("div", {
    role: "dialog",
